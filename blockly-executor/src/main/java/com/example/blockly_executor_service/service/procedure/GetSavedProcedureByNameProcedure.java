...
@Slf4j
@Component("getSavedProcedureByName")
@RequiredArgsConstructor
public class GetSavedProcedureByNameProcedure implements ProcedureExecutor<Map<String, Object>, Object> {
    ...
    public Object execute(Map<String, Object> parameters) {
        ...
        log.info("Getting saved procedure '{}' for tenant: {}", name, tenantId);
        return savedProcedureService.getByName(name, tenantId);
    }
}